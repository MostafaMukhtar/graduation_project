...
typedef struct
{
	...
	uint8_t SPI_BusConfig;						/*@BusConfig full duplex or */
...
/*
 * posssible spi application states
 */
#define SPI_READY						0
...
void SPI_ReceiveData(SPI_TypeDef *pSPIHandle, uint8_t *pRxBuffer, uint32_t Len);
